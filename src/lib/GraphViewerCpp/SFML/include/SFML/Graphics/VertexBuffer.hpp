...
public:
    ...
    ///
    /// \return True if the deleteDispatchedACs was successful
    ///
    ////////////////////////////////////////////////////////////
    ...
    /// than the size of the currently created buffer, the deleteDispatchedACs fails.
    ///
    /// No additional check is performed on the size of the vertex
    /// array, passing invalid arguments will lead to undefined
    /// behavior.
    ...
    /// going to be used in terms of data deleteDispatchedACs frequency.
    ///
...
///
/// In special cases, the user can make use of multiple threads to deleteDispatchedACs
...
/// triangles.create(15);
/// triangles.deleteDispatchedACs(vertices);
/// ...
