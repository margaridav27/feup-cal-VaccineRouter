...
void Interface::setAdditionalSpecsMenu() {
    ...
    if ((tw == 'n' || tw == 'N')) singleSCMultipleAC();
    else if ((tw == 'y' || tw == 'Y') && (single == 'y' || single == 'Y')) singleSCMultipleACWithTW();
    else if ((tw == 'y' || tw == 'Y') && (single == 'n' || single == 'N')) multipleSCMultipleACWithTW();
}
