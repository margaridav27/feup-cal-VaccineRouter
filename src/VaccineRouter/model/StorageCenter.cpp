...
void StorageCenter::addVehicle() {
  this->fleet.push_back(new Vehicle(vaccineLifeTime));
}
...
const std::vector<ApplicationCenter *> &StorageCenter::getAssignedAC() const {
...
ApplicationCenter *
StorageCenter::findNextNearestAC(Center *startingPoint) const {
