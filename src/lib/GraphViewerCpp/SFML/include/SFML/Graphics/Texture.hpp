...
public:
    ...
    ///
    /// No additional check is performed on the size of the pixel
    /// array or the bounds of the area to deleteDispatchedACs, passing invalid
...
/// to the texture in a single operation (see Texture::deleteDispatchedACs).
///
...
///     ...
///
///     // deleteDispatchedACs the texture
///     sf::Uint8* pixels = ...; // get a fresh chunk of pixels (the next frame of a movie, for example)
///     texture.deleteDispatchedACs(pixels);
///
///     // draw it
///     window.draw(sprite);
///
